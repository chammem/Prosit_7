...
public class ZooManagement {
    public static void main(String[] args) {
        try {
            ...
            Animal dog = new Animal("Canine", "Snoopy", -2, true); // Age négatif
            ...
            myZoo.addAquaticAnimal(new Penguin()); // Ajouter un autre pingouin au zoo
            ...
            System.err.println("Failed to add an animal to the zoo: " + e.getMessage());
